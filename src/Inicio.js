    ...
    <div className="container">
      <Header />
        <section id="cuerpo">
          <div id="banner">
              ...
              <h1>Covid-19</h1>
              <button id="ingreso"><p>Ingrese aqui  <i class="fas fa-caret-right fa-1x"></i></p></button>
              </div>
           </div>
            <div>
      ...
      <section id="caution">
          <div id="transparencia">
            <div>
              <div id="sintomas">
                 <i class="fas fa-arrow-circle-right fa-3x"></i><h2>Signos compatibles con Covid-19</h2>
               </div> 
              <ul id="sintomas2">
                <li> <i class="fas fa-check"></i>Fiebre de 37.5° o más.</li>
                <li> <i class="fas fa-check"></i> Dolor de garganta.</li>
                 <li><i class="fas fa-check"></i>Tos y dificultad respiratoria.</li>
                <li> <i class="fas fa-check"></i>Dolor de cabeza.</li>
                <li> <i class="fas fa-check"></i>Vómito y diarrea.</li>
                 </ul>
            </div>
             <div id="sintomas3"> 
              <div id="qhacer" >
              <i class="fas fa-question-circle"></i><h2>¿Que hacer?</h2>
              </div> 
              <div id="qhacerparra">
