...
import '../components/formunuevo/Formpaciente.css';
...
function FormularioNuevo(props){
  ...
  const getDataById = async (id) => {
    const doc = await db.collection('pacientesdata').doc(id).get();
   setValues({...doc.data()})
   }
    ...
    <h5 className='datospaciente'>DATOS DEL PACIENTE</h5>
        ...
        <div className="Informacion_contacto">
            ...
            <select name='departamento'>
                    <option selected value="">Departamento de residencia</option>
                ...
                <select name='municipio' >
                    <option selected defaultValue="=">Municipio de residencia</option>
